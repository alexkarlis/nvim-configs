...
" Better commenting
nnoremap <space>/ <Plug>(comment_toggle_linewise_current)
...
noremap <leader>p :read !pbpaste --clipboard --output<cr>
noremap <leader>c :w !pbcopy -ib<cr><cr>
